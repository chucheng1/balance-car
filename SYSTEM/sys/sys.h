...
extern int Vertical_out,Velocity_out,Turn_out, PWM_out;
extern int PWM_speed_out,Encoder_Err,Encoder_S,EnC_Err_Lowout,EnC_Err_Lowout_last;

extern char  Bluetooth_data;
extern char stop;

extern float
	Vertical_Kp,	//直立环KP、KD-198
	Vertical_Kd;
extern float
