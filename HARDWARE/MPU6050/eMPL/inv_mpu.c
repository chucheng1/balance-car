...
//		printf("mpu reset device\r\n");
    ...
    rev = ((data[5] & 0x01) << 2) | ((data[3] & 0x01) << 1) |
        (data[1] & 0x01);
//		printf("data[5]=%d\rdata[3]=%d\rdata[1]=%d\r",data[5],data[3],data[1]);
//		printf("rev=%u\r\n",rev);
    if (rev) {
...
//	printf("mpu zhunbei chushihua\r\n");
	if(mpu_init()==0)	//初始化MPU6050
	{	 
//		printf("mpu kaishi chushihua\r\n");
